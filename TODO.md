...
- [x] **Embedding model and provider decisions** ([#40](https://github.com/garyseconomics/chatbot/issues/40)) -- Reviewed 2026-03-22: `qwen3-embedding:8b` (MTEB 70.58) is still the best embedding model available on Ollama. Re-check in mid-2026.
